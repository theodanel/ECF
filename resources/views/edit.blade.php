...
@section('content')
    ...
    <form action="" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $matela->name)  }}" class="rounded shadow border-gray-300 w-full">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price" id="price" value="{{ old('price', $matela->price)  }}" class="rounded shadow border-gray-300 w-full">
            @error('price')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="discount" id="discount" value="{{ old('discount', $matela->discount)  }}" class="rounded shadow border-gray-300 w-full">
            @error('discount')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="height" id="height" value="{{ old('height', $matela->height) }}" class="rounded shadow border-gray-300 w-full">
            @error('height')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="image" id="image" value="{{ old('image', $matela->image)  }}" class="rounded shadow border-gray-300 w-full">
            @error('image')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
